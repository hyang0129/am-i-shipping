...
def run_synthesis(
    ...
    * Dry-run path (``dry_run=True``):
    ...
    try:
        ...
        #
        # IMPORTANT: this capture must run AFTER the MAX_UNITS_PER_PROMPT
        # truncation above so that downstream gap/revision passes operate on
        # exactly the same set of units that was fed to the synthesis prompt.
